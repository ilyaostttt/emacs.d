(custom-set-variables
 ...
 '(grep-find-ignored-directories (quote ("SCCS" "RCS" "CVS" "MCVS" ".svn" ".git" ".hg" ".bzr" "_MTN" "_darcs" "{arch}" ".tmp")))
...
(custom-set-faces
 ...
 '(org-meta-line ((t nil)))
 '(org-target ((t (:foreground "deep sky blue" :underline "deep sky blue"))))
